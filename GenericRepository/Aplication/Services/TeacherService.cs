    ...
    public class TeacherService
    {
        ...
        public void Add()
        {
            var t = new Teacher
            {
                ...
                Specialty = ReadString("Specialty: "),
                ExperienceYear = ReadInt("Experience (yil): ")
            };
        ...
        public void Update()
        {
            ...
            {
                Id = id,
                FullName = ReadString($"FullName ({old.FullName}): ", true) is string fn && fn != "" ? fn : old.FullName,
                Specialty = ReadString($"Specialty ({old.Specialty}): ", true) is string sp && sp != "" ? sp : old.Specialty,
                ExperienceYear = ReadInt($"Exp ({old.ExperienceYear}): ", true, old.ExperienceYear)
            };

            Console.WriteLine(_repo.Update(t) ? "Yangilandi!" : " Yangilashda xato!");
        }
